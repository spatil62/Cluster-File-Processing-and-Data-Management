...
splitDF.write.format("overwrite").csv("s3:30-newcsv")
splitDF.write.format("overwrite").parquet("s3:30-newparquet")
splitDF.write.format("overwrite").json("s3:30-newjson")
splitDF.write.format("overwrite").option("compression", "lz4").csv("s3:30-lz4com")
writenewDF = splitDF.coalesce(1)
writenewDF.write.format("overwrite").csv("s3:30-singlepart")
